...
from data import WiderFaceDetection, detection_collate, preproc, cfg_mnet, cfg_re50, cfg_sel60, cfg_effb0
...
parser.add_argument('--optimizer', default='sgd', help='Optimizer SGD, Adam, SGDP or AdamP')
